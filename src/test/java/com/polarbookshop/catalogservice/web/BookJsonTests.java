...
public class BookJsonTests {
    ...
    void testSerialize() throws Exception {
        var now = Instant.now();
        var book = new Book(123L, "1234567890", "Title", "Author", 9.90, "Polarsophia", now, now,2);
    ...
    void testDeserialize() throws Exception {
        ...
        assertThat(json.parse(content))
                ...
                .isEqualTo(new Book(1L, "1234567890", "Title", "Author", 9.90, "Polarsophia", instant, instant,1));
    }
}
